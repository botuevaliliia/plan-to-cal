...
export const ConflictWarnings = ({ conflicts }: ConflictWarningsProps) => {
      ...
      <Alert variant="destructive" className="border-0">
        ...
        <AlertDescription>
          ...
          <div className="mt-3 text-sm">
            <strong>Suggestions:</strong> Try extending your date range, adjusting work hours, or reducing task durations.
          </div>
        </AlertDescription>
      </Alert>
    </Card>
